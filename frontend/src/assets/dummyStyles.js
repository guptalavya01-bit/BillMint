...
export const aiInvoiceModalStyles = {
  ...
  textarea: "w-full rounded-md border text-gray-500 border-gray-200 px-3 py-2 text-sm resize-vertical focus:ring-2 focus:ring-emerald-100",
  error: "mt-3 text-sm text-rose-600",
  actions: "mt-4 flex justify-end gap-3",
  cancelButton: "px-4 py-2 rounded-md border text-sm",
  generateButton: "px-4 py-2 rounded-md bg-emerald-600 text-white text-sm disabled:opacity-60"
};
...
export const businessProfileStyles = {
  ...
  input: "w-full rounded-xl border border-gray-300 px-4 py-3 bg-white/50 backdrop-blur-sm focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-all duration-200",
  textarea: "w-full rounded-xl border border-gray-300 px-4 py-3 bg-white/50 backdrop-blur-sm focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-all duration-200",
  ...
  changeButton: "inline-flex items-center gap-2 px-3 py-2 sm:px-4 sm:py-2 md:px-5 md:py-2.5 rounded-xl bg-green-50 text-green-700 hover:bg-green-100 transition-all duration-200 cursor-pointer font-medium text-sm sm:text-base",
  ...
  // Tax Section
  taxContainer: "bg-gradient-to-br from-green-50 to-emerald-50 rounded-2xl p-6 border border-green-100",
  taxInput: "w-32 rounded-xl border border-gray-300 px-4 py-3 bg-white focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-all duration-200 font-medium text-center",
...
export const iconColors = {
  ...
  assets: "bg-teal-100 text-teal-600"
};
...
export const aiReminderModalStyles = {
  ...
  generateButton: "px-4 py-2 rounded-md bg-emerald-600 text-white text-sm"
};
...
cardSubtitle: "text-lg sm:text-xl font-semibold text-gray-900 mb-3 sm:mb-4",
  ...
  input: "w-full rounded-xl border border-gray-300 px-4 py-3 bg-white/50 backdrop-blur-sm focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-all duration-200",
  inputMedium: "w-full rounded-xl border border-gray-300 px-4 py-3 bg-white/50 backdrop-blur-sm focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-all duration-200 font-medium",
  inputCenter: "w-full rounded-xl border border-gray-300 px-4 py-3 bg-white/50 backdrop-blur-sm focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-all duration-200 text-center font-medium",
  textarea: "w-full rounded-xl border border-gray-300 px-4 py-3 bg-white/50 backdrop-blur-sm focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-all duration-200",
  inputSmall: "w-full rounded-xl border text-gray-500 border-gray-300 px-4 py-3 bg-white/50 backdrop-blur-sm focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-all duration-200 text-sm",
  ...
  saveButton: "inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-gradient-to-r from-green-600 to-emerald-600 text-white font-semibold hover:from-green-700 hover:to-emerald-700 transform hover:scale-105 transition-all duration-200 shadow-lg disabled:opacity-50 disabled:cursor-not-allowed",
  saveProfileButton: "inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-green-50 text-green-700 hover:bg-green-100 transition-all duration-200 text-sm font-medium",
  ...
  currencyButtonActive2: "border-green-500 bg-green-50 text-green-700 shadow-sm",
  ...
  statusButtonActive: "ring-2 ring-offset-2 ring-green-500 transform scale-105",
  statusButtonInactive: "opacity-80 hover:opacity-100 hover:scale-105",
  statusDropdown: "mt-2 sm:hidden w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-all duration-200",
  ...
  itemsInput:
    "rounded-xl border border-gray-300 px-4 py-3 bg-white/50 backdrop-blur-sm focus:outline-none focus:ring-2 focus:ring-green-500 transition-all duration-200 w-full min-w-0 overflow-hidden truncate text-sm sm:text-base",

  // Numeric inputs baseline styling (we keep them as text with inputMode for numeric keyboard)
  itemsNumberInput:
    "rounded-xl border border-gray-300 px-3 py-3 bg-white/50 backdrop-blur-sm focus:outline-none focus:ring-2 focus:ring-green-500 transition-all duration-200 text-right w-full min-w-0 overflow-x-auto whitespace-nowrap text-sm sm:text-base",
  ...
  changeButton: "inline-flex items-center gap-2 px-3 py-2 rounded-lg bg-green-50 text-green-700 hover:bg-green-100 transition-all duration-200 cursor-pointer text-sm font-medium",
...
export const createInvoiceIconColors = {
  ...
  billTo: "bg-teal-100 text-teal-600",
...
export const appShellStyles = {
  // Layout
  root: "min-h-screen bg-gradient-to-br from-gray-50 via-green-50/30 to-emerald-50/20",
  layout: "lg:flex",
  ...
  sidebarGradient: "absolute inset-0 bg-gradient-to-b from-green-50/5 to-transparent pointer-events-none",
  ...
  logoTextContainer: "",
  logoText: "font-bold text-3xl bg-gradient-to-r from-green-600 to-emerald-600 bg-clip-text text-transparent",
  logoUnderline: "h-0.5 w-0 group-hover:w-full bg-gradient-to-r from-green-500 to-emerald-500 transition-all duration-500 mt-1",
  ...
  sidebarLinkActive: "bg-gradient-to-r from-green-50 to-emerald-50 text-green-700 shadow-sm border border-green-100",
  ...
  sidebarIconActive: "text-green-600 scale-110",
  ...
  sidebarActiveIndicator: "w-1.5 h-1.5 rounded-full bg-green-500 animate-pulse",
  ...
  mobileLogoText: "font-bold text-xl ml-3 bg-gradient-to-r from-green-600 to-emerald-600 bg-clip-text text-transparent",
  ...
  mobileNavLinkActive: "bg-gradient-to-r from-green-50 to-emerald-50 text-green-700 border border-green-100",
  ...
  welcomeName: "bg-gradient-to-r from-green-600 to-emerald-600 bg-clip-text text-transparent",
  welcomeSubtitle: "text-xs sm:text-sm text-gray-600 mt-0.5 sm:mt-1",
  mobileUserAvatar: "lg:hidden flex items-center gap-2",
  mobileAvatar: "w-8 h-8 rounded-xl bg-gradient-to-br from-green-500 to-emerald-600 flex items-center justify-center text-white text-xs font-semibold shadow-lg",
  ...
  ctaButton: "group inline-flex  items-center gap-2 sm:gap-3 px-4 sm:px-6 py-2 sm:py-3 rounded-xl bg-gradient-to-r from-green-600 to-emerald-600 text-white font-semibold shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300 hover:from-green-700 hover:to-emerald-700 text-sm sm:text-base flex-1 sm:flex-none justify-center",
  ...
  userAvatar: "w-12 h-12 rounded-2xl bg-gradient-to-br from-green-500 to-emerald-600 flex items-center justify-center text-white font-semibold shadow-lg transform hover:scale-105 transition-all duration-300 cursor-pointer group",
...
export const dashboardStyles = {
  ...
  // Quick Stats Card
  quickStatsCard: "bg-gradient-to-br from-green-600 to-emerald-700 rounded-2xl p-6 text-white",
  quickStatsTitle: "font-semibold text-lg mb-4",
  quickStatsRow: "flex justify-between items-center",
  quickStatsLabel: "text-green-100",
  ...
  quickActionBlue: "bg-green-50 text-green-700 hover:bg-green-100",
  ...
  tableActionButton: "mt-3 sm:mt-0 inline-flex items-center gap-2 px-4 py-2 text-sm font-medium text-green-600 hover:text-green-700 transition-colors duration-200",
  ...
  // Client Avatar
  clientAvatar: "w-10 h-10 rounded-lg bg-gradient-to-br from-green-100 to-emerald-100 flex items-center justify-center text-green-600 font-medium group-hover:scale-110 transition-transform duration-200",
  clientInfo: "font-medium text-gray-900 group-hover:text-green-600 transition-colors",
  ...
  // Action Button
  actionButton: "inline-flex items-center gap-2 px-3 py-2 text-sm font-medium text-gray-600 hover:text-green-600 hover:bg-green-50 rounded-lg transition-all duration-200 group/btn",
  ...
  emptyStateAction: "text-green-600 hover:text-green-700 font-medium",
  
  // Color variants for quick action icons
  quickActionIconBlue: "bg-green-100",
...
export const invoicesStyles = {
  ...
  createButton: "inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-gradient-to-r from-green-600 to-emerald-600 text-white font-semibold hover:from-green-700 hover:to-emerald-700 transform hover:scale-105 transition-all duration-200 shadow-lg",
  ...
  filtersIconContainer: "p-2 rounded-lg bg-green-100 text-green-600",
  ...
  searchInput: "w-full rounded-xl border border-gray-300 pl-10 pr-4 py-3 bg-white/50 backdrop-blur-sm focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-all duration-200",
  selectInput: "w-full rounded-xl border border-gray-300 px-4 py-3 bg-white/50 backdrop-blur-sm focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-all duration-200",
  
  // Date Range
  dateRangeContainer: "lg:col-span-2",
  dateRangeFlex: "flex flex-col sm:flex-row sm:items-center gap-3",
  dateInput: "w-full sm:flex-1 min-w-0 rounded-xl border border-gray-300 px-4 py-3 bg-white/50 backdrop-blur-sm focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-all duration-200",
  ...
  perPageSelect: "rounded-xl border border-gray-300 px-4 py-2 bg-white/50 backdrop-blur-sm focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-all duration-200",
  ...
  clientAvatar: "w-12 h-12 rounded-xl bg-gradient-to-br from-green-100 to-emerald-100 flex items-center justify-center text-green-600 font-medium group-hover:scale-110 transition-transform duration-200",
  clientInfo: "font-medium text-gray-900 group-hover:text-green-600 transition-colors",
  ...
  viewButton: "inline-flex items-center gap-2 px-4 py-2 text-sm font-medium text-gray-600 hover:text-green-600 hover:bg-green-50 rounded-lg transition-all duration-200 group/btn",
  sendButton: "inline-flex items-center gap-2 px-4 py-2 text-sm font-medium text-green-600 hover:text-green-700 hover:bg-green-50 rounded-lg transition-all duration-200 group/btn",
  ...
  paginationNumberActive: "bg-gradient-to-r from-green-600 to-emerald-600 text-white shadow-lg",
...
export const featuresStyles = {
  ...
  // Background Elements
  backgroundBlob1: "absolute top-0 left-0 w-72 h-72 bg-green-100 rounded-full mix-blend-multiply filter blur-xl opacity-70 animate-blob",
  ...
  badge: "inline-flex items-center px-4 py-2 rounded-full bg-green-50 border border-green-100 mb-6",
  badgeDot: "w-2 h-2 bg-green-500 rounded-full mr-2 animate-pulse",
  badgeText: "text-sm font-medium text-green-700",
  ...
  featureCardGradient: "absolute inset-0 bg-gradient-to-br from-green-50/50 to-emerald-50/50 opacity-0 group-hover:opacity-100 transition-opacity duration-500",
  featureCardBorder: "absolute inset-0 rounded-2xl bg-gradient-to-r from-green-500 to-emerald-500 opacity-0 group-hover:opacity-5 transition-opacity duration-500",
  featureCardContent: "relative flex items-start gap-6",
  featureCardIconContainer: "flex-shrink-0 w-10 h-10 lg:w-8 lg:h-8 xl:w-10 xl:h-10 flex items-center justify-center rounded-xl bg-gradient-to-br from-green-500 to-emerald-500 text-white shadow-lg group-hover:shadow-xl group-hover:scale-110 transition-all duration-300",
  featureCardTextContainer: "flex-1",
  featureCardTitle: "text-sm whitespace-nowrap md:text-lg lg:text-sm xl:text-xl font-bold text-gray-900 group-hover:text-green-600 transition-colors duration-300",
  ...
  featureCardCta: "mt-4 flex items-center text-green-500 opacity-0 group-hover:opacity-100 transform translate-x-2 group-hover:translate-x-0 transition-all duration-300",
  ...
  bottomCtaButton: "group inline-flex items-center px-8 py-4 bg-gradient-to-r from-green-600 to-emerald-600 hover:from-green-700 hover:to-emerald-700 text-white font-semibold rounded-2xl shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 transition-all duration-300",
...
export const heroStyles = {
  // Section
  section: "relative min-h-screen pb-16 flex items-center justify-center overflow-hidden bg-gradient-to-br from-slate-50 via-green-50/30 to-emerald-50/20",
  
  // Background Elements
  bgElement1: "absolute top-1/4 -left-10 w-72 h-72 rounded-full blur-3xl opacity-60 bg-gradient-to-r from-green-200/40 to-emerald-300/40 animate-float-slow",
  bgElement2: "absolute bottom-1/4 -right-10 w-96 h-96 rounded-full blur-3xl opacity-50 bg-gradient-to-r from-emerald-200/30 to-teal-300/30 animate-float-medium",
  ...
  badgeDot: "w-2 h-2 rounded-full bg-gradient-to-r from-emerald-400 to-emerald-500 animate-pulse",
  ...
  headingLine2: "bg-gradient-to-r from-green-600 via-emerald-600 to-emerald-600 bg-clip-text text-transparent",
  ...
  demoFloating1:
    "hidden sm:block absolute -top-6 -left-6 w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 rounded-2xl bg-gradient-to-br from-green-100 to-emerald-100 blur-xl opacity-60 animate-float-slow pointer-events-none",
  demoFloating2:
    "hidden sm:block absolute -bottom-8 -right-8 w-20 h-20 sm:w-24 sm:h-24 md:w-32 md:h-32 rounded-2xl bg-gradient-to-br from-emerald-100 to-teal-100 blur-xl opacity-40 animate-float-medium pointer-events-none",
  ...
  cardLogo:
    "w-8 h-8 sm:w-10 sm:h-10 rounded-xl bg-gradient-to-br from-green-500 to-emerald-600 flex items-center justify-center text-white font-bold text-xs sm:text-sm",
  ...
  itemDot:
    "w-2 h-2 sm:w-2 sm:h-2 rounded-full bg-gradient-to-r from-green-500 to-emerald-500 group-hover/item:scale-150 transition-transform duration-300",
  ...
  totalValue:
    "bg-gradient-to-r from-green-600 to-emerald-600 bg-clip-text text-transparent text-lg sm:text-xl font-bold",
  ...
  sendButton:
    "flex-1 px-4 py-3 rounded-xl bg-gradient-to-r from-green-600 to-emerald-600 text-white font-medium shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-200 group/btn text-sm sm:text-base",
  sendButtonText:
    "group-hover/btn:translate-x-1 transition-transform duration-200 inline-block",
  ...
  // Decorative Accents
  cornerAccent1:
    "hidden sm:block absolute -top-2 -right-2 w-5 h-5 sm:w-6 sm:h-6 border-t-2 border-r-2 border-green-500 rounded-tr-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-500",
  cornerAccent2:
    "hidden sm:block absolute -bottom-2 -left-2 w-5 h-5 sm:w-6 sm:h-6 border-b-2 border-l-2 border-emerald-500 rounded-bl-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-500",

  // Card Background
  cardBackground:
    "absolute inset-0 -z-10 bg-gradient-to-br from-green-50/30 to-emerald-100/20 rounded-2xl sm:rounded-3xl blur-xl transform scale-100 sm:scale-105",
...
export const invoicePreviewStyles = {
  // Layout
  pageContainer: "min-h-screen p-6 bg-gradient-to-br from-gray-50 via-green-50/30 to-emerald-50/20",
  ...
  headerInvoiceNumber: "font-semibold text-green-600",
  ...
  printButton: "inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-gradient-to-r from-green-600 to-emerald-600 text-white font-semibold hover:from-green-700 hover:to-emerald-700 transform hover:scale-105 transition-all duration-200 shadow-lg",
  ...
  emptyStateButton: "inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-gradient-to-r from-green-600 to-emerald-600 text-white font-semibold hover:from-green-700 hover:to-emerald-700 transition-all duration-200 shadow-lg"
};
// src/assets/dummyStyles.js (add these to the existing export)
export const pricingStyles = {
  ...
  // Background Elements
  bgElement1: "absolute top-0 left-0 w-72 h-72 bg-green-100 rounded-full mix-blend-multiply filter blur-xl opacity-70 animate-blob",
  bgElement2: "absolute top-0 right-0 w-72 h-72 bg-emerald-100 rounded-full mix-blend-multiply filter blur-xl opacity-70 animate-blob animation-delay-2000",
  bgElement3: "absolute -bottom-8 left-20 w-72 h-72 bg-emerald-100 rounded-full mix-blend-multiply filter blur-xl opacity-70 animate-blob animation-delay-4000",
  ...
  billingButtonActive: "bg-gradient-to-r from-green-600 to-emerald-600 text-white shadow-lg",
  ...
  featureDot: "w-2 h-2 rounded-full bg-green-500",
  
  // FAQ CTA
  faqCta: "mt-12 text-center",
  faqText: "text-gray-600 mb-6",
  contactLink: "text-green-600 font-semibold hover:text-green-700 transition-colors duration-300"
};
...
export const pricingCardStyles = {
  ...
  cardPopular: "border-green-300/60 border-4 shadow-2xl scale-105 overflow-visible z-10",
  ...
  // Gradient Overlay
  gradientOverlay: "absolute inset-0 bg-gradient-to-br from-green-50/30 to-emerald-50/20 opacity-60 z-0 pointer-events-none rounded-3xl",
  
  // Animated Border
  animatedBorder: "absolute inset-0 rounded-3xl bg-gradient-to-r from-green-500 to-emerald-500 opacity-0 group-hover:opacity-5 transition-opacity duration-500 z-10",
  ...
  pricePopular: "bg-gradient-to-r from-rose-600 to-emerald-600 bg-clip-text text-transparent",
  ...
  featureIconPopular: "bg-green-100 text-green-600",
  ...
  ctaButtonPopular: "bg-gradient-to-r from-green-600 to-emerald-600 text-white shadow-lg hover:shadow-xl hover:from-green-700 hover:to-emerald-700 transform ",
  ...
  // Decorative Accents
  cornerAccent1: "absolute -top-2 -right-2 w-6 h-6 border-t-2 border-r-2 border-green-500 rounded-tr-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-500 z-30",
  cornerAccent2: "absolute -bottom-2 -left-2 w-6 h-6 border-b-2 border-l-2 border-emerald-500 rounded-bl-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-500 z-30"
};
...
export const authStyles = {
  ...
  input: "w-full rounded-md border border-gray-200 px-3 py-2 outline-none focus:ring-2 focus:ring-emerald-200",
  passwordContainer: "relative",
  passwordInput: "w-full rounded-md border border-gray-200 px-3 py-2 pr-10 outline-none focus:ring-2 focus:ring-emerald-200",
  ...
  // Button
  submitButton: "w-full inline-flex justify-center items-center px-4 py-2 rounded-md bg-emerald-600 text-white font-medium hover:bg-emerald-700 transition",
  ...
  footerLink: "text-emerald-600 hover:underline",
...
export const navbarStyles = {
  ...
  navLink: "text-sm hover:text-emerald-600 transition",
  navLinkInactive: "text-gray-600 hover:text-emerald-600 transition",
  ...
  signUpButton: "group relative inline-flex items-center justify-center gap-2 px-6 py-3 rounded-2xl bg-gradient-to-r from-green-600 to-emerald-600 text-white font-semibold shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300 hover:from-green-700 hover:to-emerald-700 overflow-hidden",
  ...
  mobileSignUp: "block mt-2 px-4 py-2 rounded-md bg-emerald-600 text-white text-center"
};
...
export const kpiCardStyles = {
  ...
  // Background Effects
  animatedBackground: "absolute inset-0 bg-gradient-to-br from-green-50/0 via-emerald-50/0 to-teal-50/0 group-hover:from-green-50/30 group-hover:via-emerald-50/20 group-hover:to-teal-50/10 transition-all duration-500 ease-out",
  cornerAccent: "absolute top-0 right-0 w-16 h-16 bg-gradient-to-bl from-green-500/5 to-transparent rounded-bl-2xl",
...
export const loginStyles = {
  ...
  forgotPassword: "text-emerald-600 hover:underline",
  ...
  signupLink: "text-emerald-600 hover:underline"
};
...
export const footerStyles = {
  ...
  link:
    "text-sm md:text-sm lg:text-base text-gray-600 hover:text-emerald-600 transition-colors duration-200"
};
