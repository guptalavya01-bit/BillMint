          ...
          <div className={heroStyles.content}>
            <div className={heroStyles.contentInner}>
              ...
              <h1 className={heroStyles.heading}>
                <span className={heroStyles.headingLine1}>Generate Professional</span>
                <br />
                <span className={heroStyles.headingLine2}>Invoices</span>
                <br />
                <span className={heroStyles.headingLine3}>in Seconds with AI</span>
              </h1>

              {/* Description */}
              <p className={heroStyles.description}>
                BillMint uses AI to turn your plain text description
                into a complete professional invoice instantly.{" "}
                <span className={heroStyles.descriptionHighlight}>
                  Save time, look professional, get paid faster.
                </span>
              </p>
            </div>
